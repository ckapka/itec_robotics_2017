...
//Controller settings
int ltAnalogXDeadZone = 3;    //set deazone ranges each axis on each stick. Values will probably be less than 10
int ltAnalogYDeadZone = 3;
...
int const in3=47;   //Rt wheel forward enable
int const in4=49;   //Rt wheel reverse enable
...
//****===================DRIVE CONTROL======================****//
  ...
  int ltAnalogY = PS3.getAnalogHat(LeftHatY) - midVal;
